...
Object.defineProperty(WebpackFile.prototype, 'dataMap', {
  ...
  get () {
    return {
      absoluteFrom () { return path.resolve(this.context, this.relativeFrom); },
      stat () { return fs.statSync(this.absoluteFrom); },
      content () { return fs.readFileSync(this.absoluteFrom); },
      webpackTo () { return fixPath(interpolateName(this.output, this.relativeFrom, this.content)); },
      hash () { return utils.getHashDigest(this.content); }
    };
  }
});
...
enumerable.forEach(property => Object.defineProperty(WebpackFile.prototype, property, {
  ...
  set (value) {
    ...
    if (this.destructive.includes(property)) this.reset();
  },
  get () {
